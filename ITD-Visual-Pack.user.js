...
(function () {
    ...
    // (24×24, цвет текста): звезда — по закрашенной площади как соседние иконки (~40% поля, как «Лента» и «Уведы»). «Пассив» — звезда с маленькой
    ...
    const PORTAL_ICON = {
        idle: { mask: '<path d="M12 1.95L14.94 9.01L22.56 9.62L16.75 14.59L18.52 22.03L12 18.05L5.48 22.03L7.25 14.59L1.44 9.62L9.06 9.01Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>', hole: '<path d="M12 10.57L12.73 12.34L14.64 12.49L13.19 13.74L13.63 15.6L12 14.6L10.37 15.6L10.81 13.74L9.36 12.49L11.27 12.34Z" stroke="currentColor" stroke-width="1" stroke-linejoin="round"/>' },
        live: { mask: '<path d="M11.35 2.85L14.1 9.46L21.24 10.04L15.8 14.7L17.46 21.66L11.35 17.93L5.24 21.66L6.9 14.7L1.46 10.04L8.6 9.46Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M20.5 0.8C21.2 2.6 21.2 2.6 23 3.3C21.2 4 21.2 4 20.5 5.8C19.8 4 19.8 4 18 3.3C19.8 2.6 19.8 2.6 20.5 0.8Z"/><path d="M21.7 15C22.09 16.01 22.09 16.01 23.1 16.4C22.09 16.79 22.09 16.79 21.7 17.8C21.31 16.79 21.31 16.79 20.3 16.4C21.31 16.01 21.31 16.01 21.7 15Z"/><path d="M15.6 0.3C15.96 1.24 15.96 1.24 16.9 1.6C15.96 1.96 15.96 1.96 15.6 2.9C15.24 1.96 15.24 1.96 14.3 1.6C15.24 1.24 15.24 1.24 15.6 0.3Z"/>', over: '<path d="M11.35 8.66L12.64 11.77L16 12.04L13.44 14.23L14.22 17.5L11.35 15.75L8.48 17.5L9.26 14.23L6.7 12.04L10.06 11.77Z" fill="#5cc8ff" stroke="#5cc8ff" stroke-width="1.4" stroke-linejoin="round"/>' }
    };
    let eventMaskN = 0;
