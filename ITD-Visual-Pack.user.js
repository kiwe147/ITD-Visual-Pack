...
(function () {
    ...
    // (24×24, цвет текста): звезда. «Пассив» — звезда; «актив» (сайт вешает на картинку второй класс —
    // пульсацию, или меняет файл) — звезда и три искры рядом, пульсирует как у сайта.
    const PORTAL_ICON = {
        idle: '<path d="M12 3.5l2.45 5.1 5.6.75-4.1 3.9 1.05 5.55L12 16.1l-5 2.7 1.05-5.55-4.1-3.9 5.6-.75Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>',
        live: '<path d="M10.6 6l2.2 4.6 5 .7-3.65 3.5.95 5-4.5-2.4-4.5 2.4.95-5-3.65-3.5 5-.7Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M19.4 1.5C20.07 3.23 20.07 3.23 21.8 3.9C20.07 4.57 20.07 4.57 19.4 6.3C18.73 4.57 18.73 4.57 17 3.9C18.73 3.23 18.73 3.23 19.4 1.5Z"/><path d="M21.2 9.9C21.62 10.98 21.62 10.98 22.7 11.4C21.62 11.82 21.62 11.82 21.2 12.9C20.78 11.82 20.78 11.82 19.7 11.4C20.78 10.98 20.78 10.98 21.2 9.9Z"/><path d="M14.6 0.9C14.96 1.84 14.96 1.84 15.9 2.2C14.96 2.56 14.96 2.56 14.6 3.5C14.24 2.56 14.24 2.56 13.3 2.2C14.24 1.84 14.24 1.84 14.6 0.9Z"/>'
    };
    let eventMaskN = 0;
