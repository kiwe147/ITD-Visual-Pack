...
(function () {
    ...
    // (24×24, цвет текста): звезда — по закрашенной площади как соседние иконки (~40% поля, как «Лента» и «Уведы»). «Пассив» — звезда; «актив» (сайт вешает
    ...
    const PORTAL_ICON = {
        idle: { mask: '<path d="M12 2.3L14.82 9.07L22.13 9.66L16.56 14.43L18.26 21.57L12 17.74L5.74 21.57L7.44 14.43L1.87 9.66L9.18 9.07Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' },
