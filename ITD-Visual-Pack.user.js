...
(function () {
    ...
    // (24×24, цвет текста): звезда со скруглёнными лучами — по закрашенной площади как соседние иконки (~40% поля, как «Лента» и «Уведы»). «Пассив» — звезда с маленькой
    // вырезанной звёздочкой в центре (как «дырочки» у иконок ИТД); «актив» (сайт вешает
    // на картинку второй класс — пульсацию, или меняет файл) — звезда с голубой звездой прямо поверх и три искры
    // рядом, пульсирует как у сайта.
    const PORTAL_ICON = {
        idle: { mask: '<path d="M12 3.04L14.65 9.41L21.52 9.96L16.28 14.44L17.88 21.15L12 17.55L6.12 21.15L7.72 14.44L2.48 9.96L9.35 9.41Z" stroke="currentColor" stroke-width="3.2" stroke-linejoin="round"/>', hole: '<path d="M12 10.85L12.66 12.44L14.38 12.58L13.07 13.7L13.47 15.37L12 14.48L10.53 15.37L10.93 13.7L9.62 12.58L11.34 12.44Z" stroke="currentColor" stroke-width="1.4400000000000002" stroke-linejoin="round"/>' },
        live: { mask: '<path d="M11.35 4.15L13.76 9.94L20 10.44L15.24 14.52L16.7 20.61L11.35 17.34L6 20.61L7.46 14.52L2.7 10.44L8.94 9.94Z" stroke="currentColor" stroke-width="3.2" stroke-linejoin="round"/><path d="M20.5 0.8C21.2 2.6 21.2 2.6 23 3.3C21.2 4 21.2 4 20.5 5.8C19.8 4 19.8 4 18 3.3C19.8 2.6 19.8 2.6 20.5 0.8Z"/><path d="M21.7 15C22.09 16.01 22.09 16.01 23.1 16.4C22.09 16.79 22.09 16.79 21.7 17.8C21.31 16.79 21.31 16.79 20.3 16.4C21.31 16.01 21.31 16.01 21.7 15Z"/><path d="M15.6 0.3C15.96 1.24 15.96 1.24 16.9 1.6C15.96 1.96 15.96 1.96 15.6 2.9C15.24 1.96 15.24 1.96 14.3 1.6C15.24 1.24 15.24 1.24 15.6 0.3Z"/>', over: '<path d="M11.35 9.27L12.48 11.99L15.42 12.23L13.18 14.14L13.86 17.01L11.35 15.47L8.84 17.01L9.52 14.14L7.28 12.23L10.22 11.99Z" fill="#5cc8ff" stroke="#5cc8ff" stroke-width="1.92" stroke-linejoin="round"/>' }
    };
    let eventMaskN = 0;
