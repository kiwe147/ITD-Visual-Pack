...
(function () {
    ...
    // (24×24, цвет текста): звезда — по площади как соседние иконки. «Пассив» — звезда; «актив» (сайт вешает
    // на картинку второй класс — пульсацию, или меняет файл) — звезда с голубой звездой внутри и три искры
    // рядом, пульсирует как у сайта.
    const PORTAL_ICON = {
        idle: { mask: '<path d="M12 2.6L14.72 9.15L21.8 9.72L16.41 14.33L18.05 21.23L12 17.54L5.95 21.23L7.59 14.33L2.2 9.72L9.28 9.15Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' },
        live: { mask: '<path d="M11.1 3.9L13.61 9.94L20.14 10.46L15.17 14.72L16.68 21.09L11.1 17.68L5.52 21.09L7.03 14.72L2.06 10.46L8.59 9.94Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M20.4 0.9C21.1 2.7 21.1 2.7 22.9 3.4C21.1 4.1 21.1 4.1 20.4 5.9C19.7 4.1 19.7 4.1 17.9 3.4C19.7 2.7 19.7 2.7 20.4 0.9Z"/><path d="M21.8 9.2C22.19 10.21 22.19 10.21 23.2 10.6C22.19 10.99 22.19 10.99 21.8 12C21.41 10.99 21.41 10.99 20.4 10.6C21.41 10.21 21.41 10.21 21.8 9.2Z"/><path d="M15.4 0.4C15.76 1.34 15.76 1.34 16.7 1.7C15.76 2.06 15.76 2.06 15.4 3C15.04 2.06 15.04 2.06 14.1 1.7C15.04 1.34 15.04 1.34 15.4 0.4Z"/>', hole: '<path d="M11.1 9.38L12.26 12.16L15.26 12.4L12.97 14.36L13.67 17.29L11.1 15.72L8.53 17.29L9.23 14.36L6.94 12.4L9.94 12.16Z" stroke="currentColor" stroke-width="4.4" stroke-linejoin="round"/>', over: '<path d="M11.1 9.38L12.26 12.16L15.26 12.4L12.97 14.36L13.67 17.29L11.1 15.72L8.53 17.29L9.23 14.36L6.94 12.4L9.94 12.16Z" fill="#5cc8ff" stroke="#5cc8ff" stroke-width="1.4" stroke-linejoin="round"/>' }
    };
    let eventMaskN = 0;
    onDom(function eventIcon() {
        document.querySelectorAll('a[href="/event"] img').forEach(img => {
            ...
            if (svg.dataset.state !== state) {
                ...
                // hole — прорезь в значке (зазор вокруг голубой звезды), over — цветная деталь поверх
